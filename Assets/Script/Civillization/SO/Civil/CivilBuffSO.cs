...
public class CivilBuffSO : ScriptableObject
{
    ...
    private Dictionary<GameParameterSO, float> addtionalGameStats_buff = new Dictionary<GameParameterSO, float>();//存储buff 带来的数值加成
    ...
    public float getAdditonalGameStats(GameParameterSO gameStats)
    {
        float value;
    ...
    private void addVale_gameStats(GameParameterSO gameStats, float addtioanl_value)
    {
        float orginal_vlaue;
    ...
    private void subtractValue_gameStats(GameParameterSO gameStats, float addtioanl_value)
    {
